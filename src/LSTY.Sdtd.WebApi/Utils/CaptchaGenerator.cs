...
namespace LSTY.Sdtd.WebApi.Utils
{
    public class CaptchaGenerator : ICaptchaGenerator
    {
        ...
        public CaptchaGenerator(
            ...
            int imageWidth = 108, int imageHeight = 38,
            string fontName = null, int fontSize = 24,
        ...
        public byte[] GenerateImageAsByteArray(
            string captchaCode,
            SKEncodedImageFormat imageFormat = SKEncodedImageFormat.Png, int imageQuality = 100
